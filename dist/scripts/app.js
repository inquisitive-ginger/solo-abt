...
(function(){
	...
	function pressureLevel () {
		...
		pressureLevelController.$inject = ["$scope", "$mdDialog", "calcService"];
	...
	function testResults () {
		...
		var testResultsController = function($scope, $filter, calcService) {
			...
			vm.flowCoefficientResult = {
				...
				parameterValue: $filter('number')(vm.flowCoefficient, 0)
			}
		...
		testResultsController.$inject = ["$scope", "$filter", "calcService"];
...
(function(){
	...
	function parameterCard () {
		...
		parameterCardController.$inject = ["$scope"];
    ...
    function config($stateProvider, msApiProvider)
    {
        ...
        $stateProvider
            .state('app.abt_manual', {
                ...
                resolve: {
                    configData: ["msApi", function (msApi) {
...
(function ()
{
    ...
    ManualTestController.$inject = ["$scope", "configData", "utils", "calcService", "FileSaver", "Blob", "Upload", "$http"];
	angular
		.module('app.abt.manual')
...
(function ()
{
	...
	angular
		.module('app.abt.automated')
		.controller('AutomatedTestController', AutomatedTestController);

	/** @ngInject */
	function AutomatedTestController()
    {
        var vm = this;
...
(function ()
{
    ...
    ABTController.$inject = ["abtConfigData"];
	angular
		.module('app.abt')
		.controller('ABTController', ABTController);

	/** @ngInject */
	function ABTController(abtConfigData)
    {
        var vm = this;
...
(function ()
{
    ...
    NavigationController.$inject = ["$scope", "fuseTheming"];
    angular
        .module('app.navigation')
...
(function ()
{
    ...
    function routeConfig($stateProvider, $urlRouterProvider, $locationProvider)
    {
        ...
        $urlRouterProvider.otherwise('/abt/manual');
